 ...
 */
Ext.define('Admin.view.photo.PhotoBrandFormController', {
    extend: 'Admin.view.BaseViewController',

    alias: 'controller.photobrandform',
    ...
    editPhotoBrand: function () {
        ...
        if(window.action === 'update') {
            successMsg = '修改成功';
            url=Common.Config.requestPath('Brand', 'modifyBrandId');
        } else {
