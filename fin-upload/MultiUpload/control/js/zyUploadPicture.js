	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			var defaults = {
					...
					url              : "http://192.168.1.135:8004/rest/pictureserver/uploadServerPicture",  	// 上传文件的路径
			...
			this.createHtml = function(){
				...
				if(dragDrop){
		            ...
		            html += '				<div id="status_info" class="info">选中0张文件，共0B。</div>';
		            html += '				<div class="btns">';
		            html += '					<input id="fileImage" type="file" size="30" name="picturePath" '+multiple+'>';
                    html += '					<input id="picturePathName" type="text" size="30" class="picturePathName" name="picturePathName">';
			...
			this.createCorePlug = function(){
				var params = {
					...
					onSelect: function(selectFiles, allFiles) {
                        ...
                        $('#picturePathName').val(str.substring(index + 1, str.length));
