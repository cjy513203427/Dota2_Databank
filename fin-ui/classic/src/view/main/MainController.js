Ext.define('Admin.view.main.MainController', {
    ...
    setCurrentView: function(hashTag) {
        ...
        var me = this,
            ...
            view = (node && node.get('url')) || 'page404',
            lastView = me.lastView,
            existingItem = mainCard.child('component[url=' + hashTag + ']'),
            newView;
        ...
        if (!existingItem) {
            newView = Ext.create({
                xtype: view,
                url: hashTag,  // for existingItem search later
                hideMode: 'offsets'
            });
        }
     ...
     */
    logout: function () {
        Ext.Msg.confirm('温馨提示', '退出登录?', function(action) {
            if (action === 'yes') {
